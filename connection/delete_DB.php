...
if (isset ($_GET['blotter_id'])) {
    ...
    $stmt->bind_param('i', $_GET['blotter_id']);
    $stmt->execute();
}
...
if (isset ($_POST['editCase'])) {
    ...
    //         $_POST['complaint'])) {
        ...
        $stmt->bind_param('ssssssssssss', $complainant_first, $complainant_last, $complainant_middle, $complainant_address, $complainant_contact, $respondent_first, $respondent_last, $respondent_middle, $respondent_address, $respondent_contact, $complaint, $date);
